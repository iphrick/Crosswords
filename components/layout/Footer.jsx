...
export default function Footer() {
  return (
    <footer className="w-full py-10 mt-auto border-t border-slate-800 bg-slate-950/50 backdrop-blur-md">
      <div className="max-w-[1600px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
